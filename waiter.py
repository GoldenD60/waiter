...
#               I/O        I/O        INPUT     OUTPUT   OUTPUT    PUSH     PUSH      POP     POP     IF    IS    ISN'T      ADD        ADD       MINUS   MINUS     DIVIDE      DIVIDE      MULTIPLY     MULTIPLY    DUPE      DUPE     NULL    NULL      MOD      MOD      INFINITE   NO POP I/O NO POP I/O
dictionary = ["burger", "burgers", "coleslaw", "chips", "fries", "waters", "water", "salts", "salt", "if", "is", "isn't", "chicken", "chickens", "beef", "beefs", "mushroom", "mushrooms", "stuffings", "stuffing", "lemon", "lemons", "plum", "plums", "crisp", "crisps", "infinite", "ketchup", "ketchups"]
punctuation = [" ", ",", ".", ":", ";"]
